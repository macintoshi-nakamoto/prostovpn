...
Только чтение и никакого удаления — журнал, который можно почистить из той
же панели, не журнал. Записи копятся навсегда: их немного, а вопрос «кто
смотрел пароль этого клиента в марте» задают именно тогда, когда чистка
уже случилась бы.
"""
...
def list_actions(
    ...
    """Какие действия вообще встречались — для выпадающего фильтра."""

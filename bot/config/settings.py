...
# Мягкие слова («быстрый и надёжный VPN» без блокировок в тексте) были
# нужны только на время проверки платёжной системы; 05.09.2026 по просьбе
# партнёра вернули человеческие — см. utils/texts.py.
BOT_DESCRIPTION = (
    "Prosto VPN - интернет без блокировок. Сами решайте, что смотреть.\n\n"
...
# Подпись в профиле бота и в превью ссылки (Telegram режет после 120 знаков).
BOT_SHORT_DESCRIPTION = "Интернет без блокировок: кабинет, тарифы и поддержка Prosto VPN"

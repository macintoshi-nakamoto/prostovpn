...
EMOJI_IDS = {
    ...
    # Ниже — значки, которые нужны, чтобы в одном сообщении не встречалось
    # двух одинаковых: списки тарифов, тем поддержки и платформ раздают их
    # по кругу, а соседние по смыслу кнопки берут каждая свой.
    "guide": "5199809999236279190",     # 🎒  инструкция по установке
    "unlock": "5199428833773661564",    # 🔓  ключ для iPhone
    "ask": "5197567064235090434",       # 🙏  написать в поддержку
    "crypto": "5199778641680061454",    # 🤑  оплата криптовалютой
    "ticket": "5197601849175224737",    # 🎟  обращения
    "coffee": "5199858403517703658",    # ☕️  короткий срок, посуточно
    "best": "5199428700629673304",      # 💯  самый выгодный тариф
    "season": "5199745944094023728",    # 💵  сезонный тариф
    "transfer": "5197344133957591848",  # ✊  перевод дней другу
    "windows": "5197349902098670049",   # 🎩  Windows
    "android": "5199799652660062302",   # 🤖  Android
    "macos": "5197235458400103214",     # 🍿  macOS
    "ios": "5199933672819568701",       # 🐤  iPhone
    "linux": "5199448942810539243",     # 🐸  Linux
    "renew": "5197482719667331816",     # 🐰  подписка кончается, пора продлить
    # Снежинки в наборе нет, а «спит» — ровно то, что делает подписка на
    # паузе. Значок общий с «отменой», поэтому в одном сообщении они не
    # встречаются: у экрана паузы вместо «Отмены» стоит «Назад».
    "freeze": "5197293230005201451",    # 💤  подписка на паузе
}

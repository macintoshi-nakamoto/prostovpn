...
START_LEAD = "Скорость и трафик не режем ни на одном тарифе."

START_POINTS = (
    "Собственный протокол - работает там, где другие уже нет",
    "Скорость без ограничений: 4K и загрузки без пауз",

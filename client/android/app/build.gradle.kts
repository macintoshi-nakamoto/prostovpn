...
android {
    ...
    defaultConfig {
        ...
        //
        // 1.1.0 — осознанный разрыв, а не очередная сборка: приложение
        // перешло с чужого debug-ключа на постоянный релизный, и поверх
        // старых установок эта версия всё равно не встанет (Android не
        // принимает смену подписи). Ставится заново, дальше обновления
        // идут штатно.
        versionCode = 20
        versionName = "1.1.0"

...
data class Strings(
    ...
    // Приложения мимо VPN — исключение по пакету, а не по адресам.
    val appsTitle: String,
    val appsDesc: String,
    val appsNone: String,
    val appsCount: String,
    val appsSearch: String,
    val appsHint: String,
    val appsEmpty: String,
    val appsLoading: String,
...
private val RU = Strings(
    ...
    yes = "Да",
    no = "Нет",
    appsTitle = "Приложения мимо VPN",
    appsDesc = "Банк или Госуслуги можно пустить напрямую, не выключая VPN",
    appsNone = "Все приложения через VPN",
    appsCount = "Мимо VPN: %d",
    appsSearch = "Поиск приложения",
    appsHint = "Отмеченные приложения выходят в интернет напрямую — VPN их не видит. Работает с обоими протоколами.",
    appsEmpty = "Ничего не нашлось",
    appsLoading = "Собираем список…",
    adblockTitle = "Без рекламы",
    adblockDesc = "Реклама и трекеры режутся на сервере",
...
private val EN = Strings(
    ...
    yes = "Yes",
    no = "No",
    appsTitle = "Apps outside VPN",
    appsDesc = "Let a bank or government app go direct without turning the VPN off",
    appsNone = "All apps go through VPN",
    appsCount = "Bypassing VPN: %d",
    appsSearch = "Search apps",
    appsHint = "Checked apps reach the internet directly — the VPN never sees them. Works with both protocols.",
    appsEmpty = "Nothing found",
    appsLoading = "Building the list…",
    adblockTitle = "Ad blocking",
    adblockDesc = "Ads and trackers are cut on the server",

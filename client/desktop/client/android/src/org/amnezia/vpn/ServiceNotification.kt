...
import com.nexavpn.client.util.net.TrafficStats.TrafficData

private const val TAG = "ServiceNotification"

private const val OLD_NOTIFICATION_CHANNEL_ID: String = "com.nexavpn.client.notification"
private const val NOTIFICATION_CHANNEL_ID: String = "com.nexavpn.client.notifications"
...
class ServiceNotification(private val context: Context) {
    ...
    fun buildNotification(serverName: String?, protocol: String?, state: ProtocolState): Notification {
        ...
        return notificationBuilder
            .setSmallIcon(R.drawable.ic_nexa_round)
            .setContentTitle((serverName ?: "Nexa VPN") + (protocol?.let { " $it" } ?: ""))

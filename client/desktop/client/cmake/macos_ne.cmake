...
set_target_properties(${PROJECT} PROPERTIES
    ...
    MACOSX_BUNDLE_INFO_STRING "NexaVPN"
    MACOSX_BUNDLE_BUNDLE_NAME "NexaVPN"
    ...
    XCODE_ATTRIBUTE_PRODUCT_NAME "NexaVPN"
    XCODE_ATTRIBUTE_BUNDLE_INFO_STRING "NexaVPN"
    ...
    XCODE_EMBED_APP_EXTENSIONS NexaVPNNetworkExtension
)

if(DEPLOY)
    if(NOT BUILD_VPN_DEVELOPMENT_TEAM OR NOT BUILD_MACOS_APP_PROFILE OR NOT BUILD_MACOS_APP_PROFILE_DEBUG)
        message(FATAL_ERROR "DEPLOY requires BUILD_VPN_DEVELOPMENT_TEAM, BUILD_MACOS_APP_PROFILE and BUILD_MACOS_APP_PROFILE_DEBUG")
    endif()
    set_target_properties(${PROJECT} PROPERTIES
        XCODE_ATTRIBUTE_CODE_SIGN_IDENTITY "Apple Distribution"
        XCODE_ATTRIBUTE_CODE_SIGN_IDENTITY[variant=Debug] "Apple Development"
        XCODE_ATTRIBUTE_CODE_SIGN_STYLE Manual
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER "${BUILD_MACOS_APP_PROFILE}"
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER[variant=Debug] "${BUILD_MACOS_APP_PROFILE_DEBUG}"
    )
else()
    set_target_properties(${PROJECT} PROPERTIES
...
set_target_properties(${PROJECT} PROPERTIES
    ...
    XCODE_ATTRIBUTE_SWIFT_OBJC_INTERFACE_HEADER_NAME "NexaVPN-Swift.h"
    XCODE_ATTRIBUTE_SWIFT_OBJC_INTEROP_MODE "objcxx"
)
if(BUILD_VPN_DEVELOPMENT_TEAM)
    set_target_properties(${PROJECT} PROPERTIES
...
target_compile_options(${PROJECT} PRIVATE
    -DGROUP_ID=\"${BUILD_OSX_GROUP_IDENTIFIER}\"
...
add_dependencies(${PROJECT} NexaVPNNetworkExtension)
...
add_custom_command(TARGET ${PROJECT} POST_BUILD
    COMMAND ${QT_BIN_DIR_DETECTED}/macdeployqt $<TARGET_BUNDLE_DIR:NexaVPN> -appstore-compliant -qmldir=${CMAKE_CURRENT_SOURCE_DIR} -no-codesign
)

...
namespace
{
    ...
    constexpr auto QT_ANDROID_CONTROLLER_CLASS = "com/nexavpn/client/qt/QtAndroidController";
    constexpr auto ANDROID_LOG_CLASS = "com/nexavpn/client/util/Log";
    constexpr auto TAG = "NexaQt";
} // namespace

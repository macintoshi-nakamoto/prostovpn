...
struct Log {
  private static let subsystemIdentifier = Bundle.main.bundleIdentifier ?? "com.nexavpn.client"
  ...
  private static let appGroupID: String = {
    ...
    #endif
    return Bundle.main.object(forInfoDictionaryKey: key) as? String ?? "group.com.nexavpn.client"
  }()

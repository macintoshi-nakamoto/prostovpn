...
#define TUNNEL_NAMED_PIPE \
  "\\\\."                 \
  "\\pipe\\ProtectedPrefix\\Administrators\\AmneziaWG\\NexaVPN"
...
bool WindowsTunnelService::start(const QString& configData) {
  ...
  service = CreateService(scm, TUNNEL_SERVICE_NAME, L"Алиса VPN (tunnel)",
  ...
  SERVICE_DESCRIPTION sd = {
      (wchar_t*)L"Manages the Алиса VPN tunnel connection"};

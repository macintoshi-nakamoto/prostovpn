...
QString SettingsUiController::getSourceUrl()
{
    return QString::fromUtf8(NEXA_SOURCE_URL);
}

QString SettingsUiController::getUpstreamUrl()
{
    return QString::fromUtf8(NEXA_UPSTREAM_URL);
}

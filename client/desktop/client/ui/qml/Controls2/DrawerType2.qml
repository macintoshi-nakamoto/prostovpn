    ...
    Connections {
        ...
        function onClosed() {
            ...
            if (root.isCollapsedStateActive()) {
                ...
                if (initialPageNavigationBarColor !== 0xFF21191D) {
        ...
        function onOpened() {
            ...
            if (isExpandedStateActive()) {
                if (PageController.getInitialPageNavigationBarColor() !== 0xFF21191D) {
                    PageController.updateNavigationBarColor(0xFF21191D)
                }
            }

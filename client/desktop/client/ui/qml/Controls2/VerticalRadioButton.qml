...
RadioButton {
    ...
    indicator: Rectangle {
        ...
        Rectangle {
            visible: !showImage && (root.pressed || root.checked)
            ...
            color: root.pressed ? AmneziaStyle.color.burntOrange : AmneziaStyle.color.goldenApricot
            opacity: root.enabled ? 1.0 : 0.3
        }

        Image {
            source: showImage ? imageSource : ""
            visible: showImage

    ...
    ColumnLayout {
        ...
        HeaderTypeWithButton {
            ...
            descriptionText: {
                ...
                // Серверы выданы панелью по логину и паролю: адрес и учётные
                // данные — не то, что человеку положено видеть. Показываем
                // страну, которую он и выбирал.
                if (PanelAuthController.isLoggedIn) {
                    return root.processedServer.serverDescription !== ""
                            ? root.processedServer.serverDescription

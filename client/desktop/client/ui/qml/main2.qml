...
Window  {
    ...
    width: GC.isDesktop() ? GC.desktopWidth : GC.screenWidth
    height: GC.isDesktop() ? GC.desktopHeight : GC.screenHeight
    minimumWidth: GC.isDesktop() ? 980 : 0
    minimumHeight: GC.isDesktop() ? 620 : 0
    maximumWidth: GC.isDesktop() ? 1680 : 600
    maximumHeight: GC.isDesktop() ? 1050 : 800
    ...
    function showUnsupportedConnectDrawer() {
        ...
        let descriptionText = qsTr("This legacy subscription format can no longer be used to connect in this application version.\nRemove the server from the app to continue.")

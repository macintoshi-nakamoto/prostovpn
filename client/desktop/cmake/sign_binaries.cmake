...
if(APPLE)
    ...
    list(FILTER client_exec INCLUDE REGEX [[NexaVPN$]])
    set(service_exec ${execs})
    list(FILTER service_exec INCLUDE REGEX [[NexaVPN-service$]])
    set(other_execs ${execs})
    list(FILTER other_execs EXCLUDE REGEX [[NexaVPN$|NexaVPN-service$]])

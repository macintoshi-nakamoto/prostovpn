...
echo "     sudo bash deploy/extra-ports.sh 2408 8443 4500 # запасные UDP-порты для AWG"
echo
...
echo "   Но проверка портов в панели не различает TCP и UDP: держать 443 и в"
echo "   запасных портах AWG, и под VLESS она не даст. Поэтому у AWG вместо"
echo "   443 берём 4500 — порт IPsec NAT-T, открыт почти везде."

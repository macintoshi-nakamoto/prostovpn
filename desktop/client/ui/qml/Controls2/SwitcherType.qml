...
Switch {
    ...
    property string defaultIndicatorColor: AmneziaStyle.color.sheerWhite
    property string checkedDisabledIndicatorColor: AmneziaStyle.color.richBrown

    property string borderFocusedColor: AmneziaStyle.color.paleGray
    property int borderFocusedWidth: 1

    property string checkedIndicatorBorderColor: AmneziaStyle.color.transparent
    property string defaultIndicatorBorderColor: AmneziaStyle.color.transparent
    property string checkedDisabledIndicatorBorderColor: AmneziaStyle.color.transparent

    property string checkedInnerCircleColor: '#FFFFFF'
    property string defaultInnerCircleColor: '#FFFFFF'
    property string checkedDisabledInnerCircleColor: AmneziaStyle.color.mistyGray
    property string defaultDisabledInnerCircleColor: AmneziaStyle.color.mutedGray

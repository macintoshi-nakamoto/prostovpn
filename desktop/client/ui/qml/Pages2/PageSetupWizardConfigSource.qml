...
PageType {
    ...
    QtObject {
        ...
        property string title: qsTr("Алиса VPN")
        property string description: qsTr("The easiest way to connect to the VPN")
        property string imageSource: "qrc:/images/controls/nexa.svg"
    ...
    QtObject {
        ...
        property string description: qsTr("Configure Алиса VPN on your own server")

...
/// Сторона приложения в разговоре с root-хелпером.
///
/// Соединение живёт ровно один запрос: так приложение не держит открытым
/// канал к root, пока пользователь просто смотрит на окно.
enum HelperClient {
    ...
    /// Установлен ли хелпер и той ли он версии.

...
/// Экран раздельного туннелирования: какой список сетей идёт мимо VPN.
struct SplitTunnelView: View {
    ...
    /// Системный выбор файла: приложение вне песочницы, поэтому доступ к
    /// выбранному файлу не требует дополнительных разрешений.

...
def set_user_active(db: OrmSession, user: User, active: bool) -> None:
    """
    Пауза доступа. Ключи с серверов не снимаем: выключение временное, а
    переиздание пиров на всех серверах — дорогая операция.
    """

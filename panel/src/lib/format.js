...
function parse(value) {
  ...
  // Бэкенд хранит и отдаёт наивное UTC — «2026-08-11T14:35:00», без Z и без
  // смещения. Такую строку new Date() по спецификации читает как МЕСТНОЕ
  // время, и у админа в UTC+3 отключившийся минуту назад клиент становился
  // «3 часа назад», а западнее UTC уезжал в будущее и печатался как «только
  // что». Достраиваем зону сами; якорь $ оставляет нетронутыми строки, у
  // которых Z или смещение уже есть.

...
// «Онлайн» — это поднятый туннель, а не оплаченная подписка и не открытое
// приложение. Прежнее «Активен» горело зелёным у всех оплативших, включая
// тех, кто ни разу не подключался, — и по нему нельзя было понять, кто
// сейчас реально пользуется сервисом.

...
/**
 * Плотная таблица «золотого» стиля.
 *
 * Колонки описываются данными, а не разметкой: одна и та же шапка,
 * сортировка и выравнивание чисел нужны на каждой странице, и повторять их
 * в JSX — верный способ разъехаться.
 */
...
/** Имя с подписью — самая частая ячейка в таблицах панели. */

/* Тарифы на главной.
   ...
   Цены приходят из панели и нигде в разметке не повторяются. Цена, забитая
   в шаблон, живёт ровно до первого изменения в админке — а расходится она
   молча, и обнаруживается тогда, когда человек уже увидел одну сумму на
   странице и другую в счёте. */

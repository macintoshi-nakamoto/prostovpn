...
/*
 * Инструкция по подключению — одна на весь сервис.
 *
 * Её видят в двух местах: на странице /guide и во вкладке кабинета. Раньше
 * это были два разных текста, и они разошлись: на странице пять платформ и
 * скриншоты, в кабинете — четыре платформы и три строки шагов. Человек,
 * пришедший из кабинета, получал инструкцию хуже, чем гость с лендинга.
 *
 * Теперь тело одно, а отличается обрамление: страница добавляет шапку сайта
 * и заголовок, кабинет — свои поля вокруг. Разница описана одним флагом
 * `embedded`, и добавить платформу или шаг теперь можно ровно один раз.
 *
...
/**
 * @param {string}  [login]    Логин вошедшего — показывается в кабинете.
 * @param {boolean} [embedded] Вкладка кабинета: без своей шапки и без
 *                             приглашений «зайти в кабинет» — человек уже там.
 */

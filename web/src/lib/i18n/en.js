export const en = {
  ...
  wizard: {
    hiTitle: "Let's get you connected",
    hiLead: "Install an app and sign in once. After that it just works.",
    here: {
      windows: "Setting up this computer?",
      macos: "Setting up this computer?",
      android: "Setting up this phone?",
      ios: "Setting up this iPhone?",
    },
    yesHere: "Yes, this one",
    noOther: "No, another device",
    pickTitle: "What are we setting up?",
    device: {
    ...
    signIn: "Sign in",
    signInLead: "Same login and password as here. Countries appear on their own — nothing to type.",
    yourLogin: "Your login:",
    iosGet: "Install AmneziaVPN",
    iosGetLead: "A free app from the App Store. We don't have our own for iPhone yet, so we work through it.",
    ...
    plan: {
      windows: {
        ...
        lead: "Two steps: download and sign in.",
        get: "The installer runs itself and takes under a minute.",
        button: "Download for Windows",
      },
      macos: {
        title: "Mac computer",
        lead: "Two steps: download and sign in.",
        get: "Open the downloaded file and drag the app into Applications.",
        button: "Download for Mac",
      },
      android: {
        title: "Android phone",
        lead: "Two steps: install and sign in.",
        get: "The phone will ask permission to install the file — allow it, this is our app.",
        button: "Download for Android",
      },
      tv: {
        title: "TV",
        lead: "The same app as for Android.",
        get: "Easiest is to download on a phone and send it to the TV, or open this page in the TV browser.",
        button: "Download for TV",
      },
      ios: {
        title: "iPhone or iPad",
        lead: "Install AmneziaVPN and add a key to it.",
        get: "",
        button: "",
      },
    },
  ...
  setup: {
    ...
    ext: {
      sectionH: "Another app",
      rowSub: "Key for Happ, Hiddify and the like",
      switchSub: "If you are setting up a new device",
      appSub: "Works with our key",
      title: "Key for your app",
      lead: "One link for every country. The app will refresh the keys itself.",
      switch: "Show setup again",
      step1: "Your app",
      step2: "Create a key",
      step2note: "One link per device, so you can revoke them one at a time without touching the rest.",
      step3: "Add the key to the app",
      os: { ios: "iPhone", android: "Android", mac: "Mac", win: "Windows" },
      install: "Install",
      add: "Add key",
      labelHint: "For example: phone",
      issue: "Create key",
      failed: "Could not issue the link. Please try again.",
      freshTitle: "Key is ready",
      freshWarn: "Copy it now: we won't show it again. Lost it? Just create a new one, it's free.",
      copy: "Copy",
      copied: "Copied",
      qrNote: "Point your phone camera at it instead of retyping",
      listTitle: "Your keys",
      noLabel: "Unnamed",
      used: "in use",
      neverUsed: "never opened",
      revoke: "Delete",
      s1: "Install the app and open it",
      s2: "Press \"Add key\" above — or paste the link into the subscription field",
      s3: "Pick a country from the list and connect",
      tail: "If the app asks for a \"subscription URL\" — that's the link.",
    },

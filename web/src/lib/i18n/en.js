export const en = {
  ...
  su: {
    ...
    heroLead: "Pick your device and app",
    tabOurs: "Prosto VPN",
    tabOther: "Happ etc.",
    ourLead: "The same login and password. Countries load by themselves.",
    amneziaLead: "Tap «Open in AmneziaVPN» or copy the key and paste it into the app. Requires AmneziaVPN 4.8.13 or newer.",
    viewKeys: "View keys",
    appStoreBtn: "How to change the App Store region",
    amneziaVlessLabel: "Backup link",
    vlessLead: "Tap the button below — the app opens and picks the key up itself. Or copy it and paste manually.",
    install: "Install {app}",
    key: "Key",
    device: "Device",
    app: "App",
    stepInstall: "1. Install {app}",
    installOurs: "Our app. Installs in under a minute.",
    installOther: "A free app; we add the key in the next step.",
    stepSignIn: "2. Sign in",
    ...
    openIn: "Open in {app}",
    noVpnKey: "The key is not issued yet — refresh the page in a minute.",
    noVpnKeyInactive: "The key is issued once the subscription is active.",
    issuingKey: "Issuing the key…",
    issueKey: "Issue the key",
    keyFailed: "The key was not issued — try again or contact support.",
    ...
    moreKeys: "All keys: AmneziaVPN, Happ and other apps",
    addDevice: "Add a device",
    noKey: "This link was issued long ago and is no longer shown. Issue a new one in the keys section.",
    deviceLimit: "Your plan allows {total} device(s), {used} in use. Disconnect a device on the home tab or pick a bigger plan.",

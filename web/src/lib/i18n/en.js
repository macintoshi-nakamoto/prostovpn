export const en = {
  ...
  su: {
    title: "Setup",
    heroTitle: "Connected in a couple of minutes",
    heroLead: "Pick what you will use",
    tabOurs: "Prosto VPN",
    tabOther: "Happ etc.",
    ourLead: "Sign in to the app with these — countries appear on their own.",
    amneziaLead: "Copy the key and paste it into AmneziaVPN.",
    vlessLead: "Tap «Add key» — the app opens by itself. Or copy the key and paste it manually.",
    install: "Install {app}",
    key: "Key",
    ...
    moreKeys: "Keys for other devices",

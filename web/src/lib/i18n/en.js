export const en = {
  ...
  account: {
    ...
    frozenSub: "Frozen since {date} — your days are safe and will be returned on unfreeze",
    frozenTitle: "Subscription paused",
    frozenHint: "VPN is off and paid days don't burn. Your expiry date shifts by the freeze time.",
    unfreezeBtn: "Unfreeze",
    freezeTitle: "Freeze subscription",
    freezeHint: "Days don't burn while VPN is paused. {left} freeze(s) left this month.",
    freezeNone: "Monthly limit reached — freezing will be available again next month.",
    freezeBtn: "Freeze",
    freezeConfirm: "Yes, freeze",
    freezeFailed: "Something went wrong. Please try again.",

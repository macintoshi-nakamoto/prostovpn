...
export const en = {
  ...
  status: {
    ...
    ctaGuide: "Guide",
    ctaBlocks: "Blocking map by carrier",
    ctaSupport: "Message support",
    cabinetNote: "You can check the status any time, even without signing in:",
  },

  // Blocking map — prostovpn.cc/blocks.
  blocks: {
    docTitle: "VPN blocking map for Russia: what works on MTS, Beeline, MegaFon right now — Prosto VPN",
    docDesc:
      "Live data from Prosto VPN apps: which connection methods work on each carrier right now. No addresses, no personal data, refreshed every minute.",
    eyebrow: "Blocking map",
    headOk: "VPN works on every carrier",
    headPartial: "Disruptions: {names}",
    headBlocked: "Blocked: {names}",
    headEmpty: "Collecting data",
    loading: "Collecting data…",
    unreachable: "Couldn't load the data — try again in a minute",
    lead:
      "Prosto VPN apps report whether a connection succeeded and which method was used. Here it's grouped by carrier: where everything is fine, where there are disruptions, where it's blocked — and what still works.",
    updated: "Updated at {time}",
    refresh: "every minute",
    noAddresses: "no addresses or personal data",
    statOperators: "carriers on the map",
    statAttempts: "connections in 24 h",
    statDevices: "devices in 24 h",
    statOkNow: "successful in the last hours",
    statOkDay: "successful in 24 h",
    legendTitle: "Connection methods",
    proto: { awg: "AmneziaWG", vless: "Reality", hy2: "Hysteria2" },
    protoHint: {
      awg: "WireGuard with obfuscation",
      vless: "looks like ordinary HTTPS",
      hy2: "fast QUIC",
    },
    viewLabel: "View",
    viewCards: "Cards",
    viewTable: "Table",
    status: { ok: "Working", partial: "Disruptions", blocked: "Blocked", quiet: "Little data" },
    kind: { cellular: "Mobile network", wifi: "Home internet", unknown: "Network" },
    basisNow: "successful connections in the last {h} h",
    basisDay: "successful in 24 h — few attempts in the last hours",
    trend: { up: "better than yesterday ({prev})", down: "worse than yesterday ({prev})", flat: "same as yesterday ({prev})" },
    sparkTitle: "Connection success by hour over the last 24 hours",
    sparkAgo: "{h} h ago",
    sparkNow: "now",
    sparkPoint: "{pct} successful of {n}",
    sparkNone: "no attempts",
    attemptsShort: "{n} tries",
    sample: "{attempts} attempts from {devices} devices in 24 h",
    bestNow: "Best right now: {proto}",
    emptyTitle: "The map is filling up",
    emptyText:
      "A carrier appears here once it has at least {attempts} attempts from {devices} different devices in 24 hours — fewer than that is one person's phone, not a carrier. Data arrives from the apps as they update.",
    watchingTitle: "Watching, but not enough data in 24 h yet",
    watchingText:
      "A carrier makes it onto the map once it has at least {attempts} attempts from {devices} different devices in 24 hours. Fewer is not statistics — it's one phone.",
    eventsTitle: "What changed in 24 hours",
    eventsEmpty: "No sharp changes in the last 24 hours: no drops, no recoveries.",
    event: { drop: "drop", recovery: "recovery" },
    table: {
      operator: "Carrier",
      status: "State",
      now: "Now",
    ...
    howTitle: "How we count",
    howItems: [
      "After every connection attempt the Prosto VPN app reports one thing to the panel: whether it worked, by which method and on which network. No addresses, nothing about what you opened — it's simply not in the report.",
      "The carrier comes from the phone's settings; for home internet — from the network's provider. Names are unified: “MTS RUS” and “Mobile TeleSystems” are the same carrier.",
      "“Now” is the last three hours. If there were few attempts in that window we show the 24-hour estimate and say so. Working — 85% successful and up, disruptions — from 50%, below that — blocked.",
      "Only carriers with enough attempts from different devices in 24 hours make it onto the map. One phone on bad Wi-Fi must not look like a whole carrier being blocked.",
      "An event is when a carrier's success rate over 24 hours changed by 15% or more versus the previous day — drops and recoveries alike.",
    ],
    coverage:
      "For now only the Android app sends data. Windows and macOS will join in the next updates — the map will get fuller.",
    ctaTitle: "Can't connect right now?",
    ctaText:
      "See which method works on your carrier and switch to it in the app. Still stuck — message us, we'll sort it out.",
    ctaConnect: "Get Prosto VPN",
    ctaChannel: "Blocking news on Telegram",
    ctaStatus: "Server status",
    ctaSupport: "Message support",
  },
      ...
      blocks: [
        {
          h: "Where to write",
          items: [
            ["Telegram", "@temnoz — the main support channel, we reply quickly. The bot @prostovpnn_bot is for purchases and the dashboard."],

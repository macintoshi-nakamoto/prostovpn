 ...
 * Страница инструкции.
 *
 * Сама инструкция живёт в GuideBody — её же показывает вкладка кабинета.
 * Здесь только обрамление: шапка сайта, заголовок с хлебными крошками и
 * футер. Так страница и кабинет не могут разойтись по содержанию.
 */
